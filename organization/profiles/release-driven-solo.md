...
ido-bata.github.io の current release-driven development で使用する Operating Model を定義します。
...
- Next.js static export / Bun / Panda CSS / GitHub Pages の既存 architecture と release docs を維持する。
- deployment evidence は current commit / built artifact へ bind し、stale Pages deployment を current proof にしない。
- organization website の public contract 変更は project-specific docs / Issue を authority とする。
